<template>
    <div class="story">
            ...
            <img class="story__image" src="@/assets/images/about/story/portrait-two-young-stylish-smiling-blond-women-holding-shopping-bags-women-dressed-summer-hipster-clothes-positive-models-posing-pink-wall.jpg" alt="About Us Image">
    </div>
</template>
